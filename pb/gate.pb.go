...
type GatePushRequest struct {
	...
	Extras  string            `protobuf:"bytes,5,opt,name=Extras,proto3" json:"Extras,omitempty"`
	TTL     uint64            `protobuf:"varint,6,opt,name=TTL,proto3" json:"TTL,omitempty"`
	M       map[string][]byte `protobuf:"bytes,7,rep,name=m" json:"m,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *GatePushRequest) GetExtras() string {
	if m != nil {
		return m.Extras
	}
	return ""
...
func (m *GatePushRequest) GetTTL() uint64 {
	if m != nil {
		return m.TTL
	}
	return 0
...
func (m *GatePushRequest) GetM() map[string][]byte {
	if m != nil {
		return m.M
	}
	return nil
...
func (m *GatePushRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Extras) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintGate(dAtA, i, uint64(len(m.Extras)))
		i += copy(dAtA[i:], m.Extras)
	}
	if m.TTL != 0 {
		dAtA[i] = 0x30
		i++
		i = encodeVarintGate(dAtA, i, uint64(m.TTL))
	}
	if len(m.M) > 0 {
		for k, _ := range m.M {
			dAtA[i] = 0x3a
...
var fileDescriptorGate = []byte{
	...
	,
}
